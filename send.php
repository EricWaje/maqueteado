...
$enviar_a = 'ericwaje03@gmail.com'; //aca va el correo en el cual queres que llegue el email que te mandan por el formulario
...
header('location: https://cvericwajnrajch.netlify.app');
